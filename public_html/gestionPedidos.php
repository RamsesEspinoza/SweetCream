            ...
            <div class="row">
                ...
                <tr>
                    ...
                    <td>ㅤㅤㅤㅤ</td>
                     ...
                     <?php
        include ("./conexion/mostrarGestionPedido.php");
        ?>
               </table>
            </div>
            <?php
                    ...
                    if (!$_GET) {
                        echo "<script>
                            window.location.href = './gestionPedidos.php?pagina=1';
                              </script>";
                    }
                    if ($inc) {
                       $aja1 = "SELECT COUNT(id_pedido) FROM pedidos";
                        $pdo = mysqli_query($conn, $aja1);
                        if ($pdo) {
                            while ($rowi = $pdo->fetch_array()) {
                                $aja2 = $rowi['COUNT(id_pedido)'];
                            }
                        }
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="shop__pagination">
                                ...
                                for ($i = 0;
                                        ...
                                        $i++):
                                    ?>
                                    <a href="gestionPedidos.php?pagina=<?php echo $i + 1 ?>"><?php echo $i + 1 ?></a>
                                <?php endfor ?>
                                <a href="gestionPedidos.php?pagina=<?php echo$_GET['pagina'] + 1 ?>" ><span class="arrow_carrot-right"></span></a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
